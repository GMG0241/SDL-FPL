...
TEAM_IDS_FILE = r"C:\Users\gabeg\Documents\Uni Work\Strategic Leadership\teamIds.csv"
TEAM_IDS = {}
...
with open(r"C:\Users\gabeg\Documents\Accurate xG\accuratexG\local\fplNamesConversionReduced.json", "r") as f:
    obj = json.load(f)
